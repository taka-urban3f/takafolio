        ...
        <main>
            <section class="p-secWorks" id="secWorks">
                ...
                <ul class="p-secWorks__catList">
                    <li class="p-secWorks__catList__item js_active_ctg"><a href="index2.html" class="js-do-barba">all</a></li>
                    <li class="p-secWorks__catList__item"><a href="index.html" class="js-do-barba">coding</a></li>
                    <li class="p-secWorks__catList__item"><a href="index2.html" class="js-do-barba">web design</a></li>
                    <li class="p-secWorks__catList__item"><a href="index2.html" class="js-do-barba">banner design</a></li>
                </ul>
                <div data-barba="container" data-barba-namespace="top">
                    <div class="p-secWorks__grid">
                        <div class="p-secWorks__grid__item">
                            <a href="works_xx.html">
                                <div class="p-secWorks__imgCtn">
                                    <img src="img/testfv.jpg" alt="" class="p-secWorks__imgCtn__img">
                                </div>
                                <p class="p-secWorks__grid__item__title">タイトル</p>
                            </a>
                        </div>
                        <div class="p-secWorks__grid__item">
                            <a href="">
